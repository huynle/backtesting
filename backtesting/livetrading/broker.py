...
class Broker:
    ...
    def get_pair_info(self, pair: Pair) -> PairInfo:
        ...
        if not ret:
            ...
            self._cached_pairs[pair] = PairInfo(
                Decimal(pair_info["base_increment"]), Decimal(pair_info["quote_increment"])
            )
    ...
    def _subscribe_to_ws_channel_events(self, channel: str, event_handler, event_source):
